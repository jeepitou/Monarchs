...
namespace TcgEngine
{
    ...
    public class ApiClient : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            _bugReportService = new BugReportService(ServerURL);
        }
        ...
        private void AfterLogin(LoginResponse login_res)
        {
            ...
            else if (!is_server && SceneNav.GetCurrentScene() != "LoginMenu")
            {
        ...
        public async void SubmitBug(string title, string description, string imagePath)
        {
            _bugReportService.SubmitBugAsync(title, description, imagePath);
        }
