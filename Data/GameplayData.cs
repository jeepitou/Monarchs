...
namespace TcgEngine
{
    ...
    //TODO refactor this to fit with my game
    ...
    public class GameplayData : ScriptableObject
    {
        ...
        public float mulligan_duration = 30f;
        public CardData second_bonus;

        public InitiativeManager.InitiativeType InitiativeType;
        public bool generateManaOnNextTurn;
        public bool canPlayCardAfterMove;

        public bool EveryPieceCanCastInterventions;
        public bool InterventionCastByNonMonarchCostsMana;

        public bool DragAndDropRangedUnitWillDoARangedAttack;

        [Header("Board")] 
        public int boardSizeX = 8;
        public int boardSizeY = 8;
        public Slot whiteMonarchStartSlot;
        ...
        public BoardSetupPosition BoardSetupPosition;

        [Header("Links")] 
        public MovementPieceTypeLink MovementPieceTypeLink;
        public MovementIconLink MovementIconLink;
        public CohortIconLink CohortIconLink;
