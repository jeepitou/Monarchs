...
namespace Monarchs
{
    ...
    public class BoundSpellFX : AbilityFX
    {
        ...
        public override void DoFX()
        {
            ...
            if (_cardData == null)
            {
                Debug.LogError($"No bound spell found for BoundSpellFX");
                return;
            }
        ...
        private void OnAbilitySummonedCardToHand(string uid)
        {
            ...
            Card card = Card.Create(_cardData, _abilityArgs.caster.VariantData, _abilityArgs.caster.playerID, uid);
        ...
        private void FindCardToCreate()
        {
            if (_abilityArgs != null && _abilityArgs.caster != null)
            {
                _cardData = _abilityArgs.caster.CardData.boundSpells[0];
            }
        }
