...
namespace TcgEngine.UI
{
    ...
    public class MainMenu : MonoBehaviour
    {
        ...
        private void AfterLogin()
        {
            ...
            //Deck
            GameClient.PlayerSettings.deck.id = PlayerPrefs.GetString("tcg_deck_" + Authenticator.Get().Username, "");
        ...
        public void StartMathmaking(GameMode mode, string group)
        {
            ...
            if (deck != null)
            {
                ...
                GameClientMatchmaker.Get().StartMatchmaking(group, GameClient.GameSettings.nb_players);
            }
        }
        ...
        public void OnClickSolo()
        {
            ...
            GameClient.AISettings.deck.id = GameplayData.Get().GetRandomAIDeck();
            GameClient.AISettings.ai_level = GameplayData.Get().ai_level;
