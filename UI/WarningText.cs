...
namespace TcgEngine.UI
{
    ...
    public class WarningText : MonoBehaviour
    {
        ...
        {
            ShowText("Piece already played this turn");
        }
        
        public static void ShowNotThisPieceTurn()
        {
            ShowText("Not this piece's turn");
        }
        ...
        public static void ShowAlreadyPlayedCard()
        {
            ShowText("You already played a card this turn");
        }

        public static void ShowCantPlayEnemyPiece()
        {
            ShowText("You can't play enemy pieces");
        }
    }
}
