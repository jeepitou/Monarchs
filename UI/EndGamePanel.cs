...
namespace TcgEngine.UI
{
    ...
    public class EndGamePanel : UIPanel
    {
        ...
        {
            //Online rewards
            if (GameClient.GameSettings.IsOnline())
            {
                string url = ApiClient.ServerURL + "/matches/" + GameClient.GameSettings.game_uid;
            ...
            //Adventure Rewards
            if (GameClient.GameSettings.game_type == GameType.Adventure)
            {
                LevelData lvl = LevelData.Get(GameClient.GameSettings.level);
