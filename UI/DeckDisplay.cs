...
namespace TcgEngine.UI
{
    ...
    public class DeckDisplay : MonoBehaviour
    {
        ...
        public HandCardUIManager[] ui_card_managers;
        ...
        public void Clear()
        {
            ...
            if (card_count != null)
                card_count.text = "";
            foreach (HandCardUIManager card in ui_card_managers)
                card.cardUI.Hide();
        }
        ...
        {
            cards.Sort((CardDataQ a, CardDataQ b) => { return b.card.manaCost.CompareTo(a.card.manaCost); });

            int index = 0;
            foreach (CardDataQ icard in cards)
            {
                if (index < ui_card_managers.Length)
                {
                    HandCardUIManager card_ui = ui_card_managers[index];
